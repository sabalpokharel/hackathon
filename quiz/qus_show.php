...
<head>
  ...
  <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrt
...
<div class="container">
	...
	<div class="col-sm-8">
		  <h2 style="text-align: center;color: #ff4d0b;font-weight: bold">Online exam</h2>
		  <script type="text/javascript">
		...
		<form method="post" id="form1" action="answer.php" style="background-color: #f3f3df;border: 1px ridge black">
		...
		<?php $i++;}?>
	<center><input type="submit" value="Submit" class="btn btn-success"/ style="padding: 10px;background-color: #ff4d0b; color: white;cursor: pointer;border-radius: 8px; margin-bottom: 20px"></center>
</form>	
		</div>
<div class="col-sm-2"></div>
</div>
